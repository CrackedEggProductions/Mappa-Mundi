...
**Road End** — production filename stem: `road_end`. Art status: **NEEDS REVIEW**.

## 2. Authoritative role

Basic Act-I Expansion; the same design starts or terminates a Road. Starting bag: **3 copies**.

Source: [Complete Alpha Rules](../../../Carcassonne_Roguelite_Alpha_Complete_Rules.md), **RULE-CAT-008**; bag counts follow **RULE-BAG-002**. This brief defines art, not gameplay.
...
One Road component meets north and ends internally; other sides remain Field.

## 5. Visual communication goals

A clean, narrow north road ends visibly within open country. Sparse endpoint detail may help without becoming Settlement geography. Follow the [master art recipe](../../specs/master_tile_art_spec.md): parchment first, fine sepia ink second, restrained color wash third. No scenic painting or 3D rendering.
...
- [01 road end](../../references/approved_style/ref_01_road_end.png) — style anchor; not a mechanically certified final.
...
Probable south Road endpoint; reeds and the rounded terminus create water ambiguity. Confirm identity before treating it as mechanical evidence. Example orientation/width is subordinate to this brief and the alignment spec; “approved reference” does not mean final production art.

## 9. Forbidden mistakes

Do not create a separate Road Start design, another exit, or a village that implies an unlisted Settlement. Do not copy texture borders, off-center sockets or topology defects from a reference. Never let scenery imply additional feature exits.
